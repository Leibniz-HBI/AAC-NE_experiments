...
class NuclearDataProcessor(DataProcessor):
    """
    ...
    TRAIN_FILE_NAME = "NuclearEnergy_train.csv"

    # Set this to the name of the file containing the dev examples
    DEV_FILE_NAME = "NuclearEnergy_dev.csv"

    # Set this to the name of the file containing the test examples
    TEST_FILE_NAME = "NuclearEnergy_test.csv"

    # Set this to the name of the file containing the unlabeled examples
    UNLABELED_FILE_NAME = "NuclearEnergy_unlabeled.csv"

    # Set this to a list of all labels in the train + test data
    LABELS = ['reactorsecurity','weapons','waste','enviroment/health','reliability','costs','alternatives','improvement','other']
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, NuclearDataProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, NuclearDataProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, NuclearDataProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, NuclearDataProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return NuclearDataProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                guid = "%s-%s" % (set_type, idx)
                label = row[NuclearDataProcessor.LABEL_COLUMN]
                text_a = row[NuclearDataProcessor.TEXT_A_COLUMN]
                text_b = row[NuclearDataProcessor.TEXT_B_COLUMN] if NuclearDataProcessor.TEXT_B_COLUMN >= 0 else None
                example = InputExample(guid=guid, text_a=text_a, text_b=text_b, label=label)
                examples.append(example)
...
PROCESSORS = {
    ...
    "ax-g": AxGProcessor,
    "ax-b": AxBProcessor,
    "nuclear-aspect": NuclearDataProcessor
...
#    "nuclear-aspect": task_helpers.MultiMaskTaskHelper
}

METRICS = {
    "cb": ["acc", "f1-macro"],
    "multirc": ["acc", "f1", "em"],
    "nuclear-aspect" : ["acc", "f1-macro", "precision", "recall"]
}

DEFAULT_METRICS = ["acc", "f1-macro", "precision", "recall"]
...
PROCESSORS[NuclearDataProcessor.TASK_NAME] = NuclearDataProcessor
