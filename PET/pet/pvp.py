...
class NuclearEnergyAspectPVP(PVP):
    """
    """
    ...
    #    "waste":['nuclear waste'],
    #    "enviroment/health":['health and environment'],
    #    "reliability":['energy supply reliability'],
    #    "costs":['costs'],
    #    "alternatives":['alternative energies'],
    #    "improvement":['technological innovation'],
    #    "other":['other aspects']
    #}

    VERBALIZER = {
        "reactorsecurity":['safety'],
        "weapons":['weapons'],
        "waste":['was'],
        "enviroment/health":['health'],
        "reliability":['rel'],
        "costs":['costs'],
        "alternatives":['alt'],
        "improvement":['improve'],
    ...
    def get_parts(self, example: InputExample):
        ...
        # can also be empty).
        if self.pattern_id == 0:
            return ['This argument addresses the aspect ', self.mask, ' in the nuclear energy debate.'], [text_a]
        elif self.pattern_id == 1:
            return ['In the nuclear energy debate, \"', text_a, '\" is about ', self.mask], []
        elif self.pattern_id == 2:
            return ['This atomic energy argument refers to ', self.mask], [text_a]
        else:
            raise ValueError("No pattern implemented for id {}".format(self.pattern_id))

    def verbalize(self, label) -> List[str]:
        return NuclearEnergyAspectPVP.VERBALIZER[label]
...
PVPS = {
    ...
    'ax-b': RtePVP,
    'ax-g': RtePVP,
    'nuclear-aspect': NuclearEnergyAspectPVP
}
