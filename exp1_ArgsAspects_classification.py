...
for model_i, model_to_test in enumerate(models_to_test):
    ...
    # Eval best model
    model = ClassificationModel(model_to_test[0], train_args['best_model_dir'], use_cuda=use_cuda, cuda_device=0, args=train_args)
